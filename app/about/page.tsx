...
export default function AboutPage() {
  return (
    <div className="page-shell pb-16">
      <section className="grid gap-12 pt-16 lg:grid-cols-[minmax(0,1.05fr),minmax(0,0.95fr)] lg:items-center lg:gap-16">
        <div className="space-y-6">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Link
              href="/services"
              className="rounded-full bg-white px-6 py-3 text-sm font-semibold text-[color:var(--foreground)] shadow-sm ring-1 ring-[color:color-mix(in_srgb,var(--support)_25%,white_75%)] transition hover:bg-[#fde6ec] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[color:var(--accent-soft)]"
            >
              Explore Services
            </Link>
          </div>
        ...
        <div className="relative flex justify-center lg:justify-end">
          <div className="absolute inset-0 -z-10 rounded-full bg-[color:rgba(212,235,224,0.85)] blur-3xl" />
          <Image
      ...
      <section className="mt-12 surface-section rounded-3xl p-8 shadow-sm ring-1 ring-[color:color-mix(in_srgb,var(--support)_25%,white_75%)] sm:p-10">
        ...
        <div className="mt-6 grid gap-6 md:grid-cols-2">
          <article className="rounded-2xl bg-[color:color-mix(in_srgb,var(--accent-soft)_40%,white_60%)] p-6">
            ...
            <p className="mt-3 text-sm text-[color:color-mix(in_srgb,var(--foreground)_65%,black_35%)]">
