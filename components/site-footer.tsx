...
export function SiteFooter() {
  return (
    <footer className="bg-[linear-gradient(180deg,rgba(30,63,58,0.96)0%,rgba(24,48,45,0.94)45%,rgba(73,123,120,0.88)100%)] text-[color:rgba(255,255,255,0.9)]">
      ...
      <div className="border-t border-[color:color-mix(in_srgb,var(--earth)_65%,var(--accent)_35%)] bg-[color:color-mix(in_srgb,var(--forest)_90%,black_10%)]">
